...
A partir dos dados confiáveis da Silver, foram criadas tabelas agregadas contendo métricas de negócio,
análises dimensionais e informações de observabilidade do pipeline.
...
Resultado:
A camada Gold disponibiliza dados preparados para consumo analítico e acompanhamento operacional,
garantindo confiabilidade através de métricas de negócio, indicadores de processamento e
